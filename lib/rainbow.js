...
export default {
  ...
  activate () {
    ...
    this.disposables.add(atom.workspace.observeTextEditors(editor => {
      ...
      disposables.push(atom.config.observe('rainbow.colorRange', { scope: rootScopeDescriptor }, newValue => {
        rainbowEditor.colorRange = newValue
      }))

      disposables.push(atom.config.observe('rainbow.quotes', { scope: rootScopeDescriptor }, newValue => {
        rainbowEditor.quotes = [...newValue.trim()]
      }))

      disposables.push(atom.config.observe('rainbow.pairs', { scope: rootScopeDescriptor }, newValue => {
